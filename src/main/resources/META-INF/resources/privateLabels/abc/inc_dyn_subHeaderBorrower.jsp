...
boolean clientMode = com.selectica.tools.DetermineUtils.isClientMode(com.selectica.accountmanagement.RequestStateHolder.getHttpRequest());
   if(isMobile){
%>
<%@ include file="/privateLabels/Base/inc_dyn_mobile_subHeaderBorrower.jsp" %>
<% }else{ %>
...
<script language="JavaScript" type="text/javascript">
    ...
    <script language="JavaScript" type="text/javascript" src="privateLabels/Base/new_ui/main.js"></script>
    <link rel="stylesheet" type="text/css" href="privateLabels/Base/new_ui/main.css" />
