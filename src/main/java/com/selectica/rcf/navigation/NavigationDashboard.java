package com.selectica.rcf.navigation;
...
public class NavigationDashboard {
    ...
    public void append_Inbox_MyContracts(BundleSummaryItem bundleSummaryItem) {
        new BundleFilterLogicBuilder()
                    .buildList("MyContracts")
                    .appendBundleFilterLogicWithClass("CurrentUserIsOwner",null,"com.selectica.navsumm.CurrentUserIsOwnerBundleLogic")
                    .appendBundleFilterLogicWithScript("MyContractsFilter",true,"\n"+
"                            var taskName = thisBundle.getValue(\"activeTaskName\");\n"+
"                            result = taskName != 'Complete' && taskName != 'Manage';\n"+
"                        ")
...
"                        ")
    ...
    public void append_Inbox_MyAlerts(BundleSummaryItem bundleSummaryItem) {
        new BundleFilterLogicBuilder()
                    .buildList("MyActiveAlerts")
                    .appendBundleFilterLogicWithClass("CurrentUserHasRemindersBundleLogic",null,"com.selectica.navsumm.CurrentUserHasRemindersBundleLogic")
                    .useFor(bundleSummaryItem);
    }
    ...
    public void append_ExpirationSchedule_ContractsExpiringToday(BundleSummaryItem bundleSummaryItem) {
        new BundleFilterLogicBuilder()
...
"                        ")
    ...
    public void append_ExpirationSchedule_ContractsExpiringThisMonth(BundleSummaryItem bundleSummaryItem) {
        new BundleFilterLogicBuilder()
...
"                        ")
    ...
    public void append_ExpirationSchedule_ContractsExpiringIn3Months(BundleSummaryItem bundleSummaryItem) {
        new BundleFilterLogicBuilder()
...
"                        ")
    ...
    public void append_ExpirationSchedule_Summary(SummaryDisplayDef2 summaryDisplayDef) {
        new SummaryDisplayDefBuilder()
                    .appendAliasDef("viewWFStage","Stage")
                    .setDisplayHint("pix/meta/bump.gif")
                    .setAligment("center")
