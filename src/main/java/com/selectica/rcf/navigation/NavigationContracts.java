...
"                            ")
    ...
    public void append_General_RealEstateLease_0(BundleSummaryItem bundleSummaryItem) {
        new BundleFilterLogicBuilder()
                    .buildList("")
                    .appendBundleFilterLogicWithScript("1",null,"\n"+
"\n"+
"                                result = thisBundle.getInfoValueObject(\"agrType\") == 'Real Estate/Lease';\n"+
"\n"+
"                            ")
                    .useFor(bundleSummaryItem);
    }

    public void append_General_Employment_0(BundleSummaryItem bundleSummaryItem) {
        new BundleFilterLogicBuilder()
                    .buildList("")
                    .appendBundleFilterLogicWithScript("1",null,"\n"+
"\n"+
"                                result = thisBundle.getInfoValueObject(\"agrType\") == 'Employment';\n"+
"\n"+
"                            ")
                    .useFor(bundleSummaryItem);
    }
...
"                            ")
    ...
    public void append_Framework1_RealEstateLease_0(BundleSummaryItem bundleSummaryItem) {
        new BundleFilterLogicBuilder()
                    .buildList("")
                    .appendBundleFilterLogicWithScript("1",null,"\n"+
"\n"+
...
"                            ")
    ...
    public void append_Framework1_Employment_0(BundleSummaryItem bundleSummaryItem) {
        new BundleFilterLogicBuilder()
                    .buildList("")
                    .appendBundleFilterLogicWithScript("1",null,"\n"+
"\n"+
