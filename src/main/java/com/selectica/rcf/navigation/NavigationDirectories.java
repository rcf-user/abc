...
public class NavigationDirectories {
    ...
    public void append_Vendor_All_Summary(SummaryDisplayDef2 summaryDisplayDef) {
    ...
    public void append_Customer_All_Summary(SummaryDisplayDef2 summaryDisplayDef) {
        new SummaryDisplayDefBuilder()
                    .appendAliasDef("viewWFStage","Stage")
                    .setDisplayHint("pix/meta/bump.gif")
                    .setAligment("center")
    ...
    public void append_Counterparty_All_Summary(SummaryDisplayDef2 summaryDisplayDef) {
        new SummaryDisplayDefBuilder()
                    .appendAliasDef("viewWFStage","Stage")
                    .setDisplayHint("pix/meta/bump.gif")
                    .setAligment("center")
